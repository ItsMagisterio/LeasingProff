            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        ...
                        <li>
                            <a href="mailto:webmaster@лизинг.орг" class="d-flex text-decoration-none" title="Написать нам на почту">
                                <i class="fas fa-envelope me-3 mt-1 text-primary"></i>
                                <span>webmaster@лизинг.орг</span>
                            </a>
                        </li>
                        <li>
                            <div class="d-flex">
                ...
                <div class="col-lg-10">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <p>Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных, предоставляемых пользователями при использовании сайта и услуг компании "лизинг.орг".</p>
                            
                            <h4 class="mt-4">1. Общие положения</h4>
                            <p>1.1. Настоящая Политика конфиденциальности является официальным документом и определяет порядок обработки и защиты информации о физических и юридических лицах, использующих сайт и услуги "лизинг.орг".</p>
                            ...
                            <p>1.4. Используя сайт и услуги "лизинг.орг", пользователь выражает свое согласие с условиями настоящей Политики конфиденциальности.</p>
                            
                            <h4 class="mt-4">2. Сбор и использование персональных данных</h4>
                            <p>2.1. Компания "лизинг.орг" собирает и хранит только ту персональную информацию, которая необходима для предоставления услуг лизинга и связанных с ними сервисов.</p>
                            <p>2.2. Персональная информация пользователя, которую обрабатывает "лизинг.орг", включает в себя:</p>
                            <ul>
                            ...
                            <p>3.1. "лизинг.орг" обрабатывает персональные данные пользователей в следующих целях:</p>
                            <ul>
                            ...
                            <p>4.1. "лизинг.орг" принимает необходимые организационные и технические меры для защиты персональной информации пользователя от неправомерного или случайного доступа, уничтожения, изменения, блокирования, копирования, распространения, а также от иных неправомерных действий третьих лиц.</p>
                            
                            <h4 class="mt-4">5. Заключительные положения</h4>
                            <p>5.1. "лизинг.орг" имеет право вносить изменения в настоящую Политику конфиденциальности. При внесении изменений в актуальной редакции указывается дата последнего обновления.</p>
                ...
                <div class="col-lg-10">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <p>Настоящий документ определяет условия использования сайта и услуг компании "лизинг.орг". Используя наш сайт и услуги, вы соглашаетесь с настоящими условиями.</p>
                            
                            <h4 class="mt-4">1. Общие положения</h4>
                            <p>1.1. Сайт и услуги "лизинг.орг" предназначены для предоставления информации о лизинговых продуктах и услугах, а также для оформления заявок на лизинг.</p>
                            <p>1.2. Компания "лизинг.орг" оставляет за собой право в любое время изменять, добавлять или удалять пункты настоящих Условий без уведомления пользователя.</p>
                            <p>1.3. Продолжение использования сайта и услуг "лизинг.орг" после внесения изменений в Условия означает принятие и согласие пользователя с такими изменениями.</p>
                            ...
                            <p>3.1. Компания "лизинг.орг" не несет ответственности за временные технические сбои и перерывы в работе сайта, а также за их последствия.</p>
                            <p>3.2. Компания "лизинг.орг" не несет ответственности за любые убытки, которые пользователь может понести в результате использования или невозможности использования сайта.</p>
                            ...
                            <p>4.1. Все материалы, размещенные на сайте "лизинг.орг", включая тексты, графику, логотипы, изображения, а также их подборка и расположение, являются интеллектуальной собственностью компании и защищены законодательством Российской Федерации.</p>
...
function includeHomePage() {
    ...
    <section class="features-section py-5">
        <div class="container">
            <h2 class="text-center mb-5">Почему выбирают лизинг.орг</h2>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
    ...
    echo '<section class="py-5 bg-light" id="about">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h2 class="mb-4">О компании лизинг.орг</h2>
                    <p class="lead">Мы помогаем клиентам получить недвижимость и транспорт мечты на выгодных условиях с 2010 года.</p>
                    <p>Компания лизинг.орг специализируется на предоставлении услуг лизинга недвижимости и транспорта для физических и юридических лиц. Мы сотрудничаем со всеми крупнейшими застройщиками и автопроизводителями, предлагая широкий выбор объектов недвижимости и автомобилей различных категорий.</p>
